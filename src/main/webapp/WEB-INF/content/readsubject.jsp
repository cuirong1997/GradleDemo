...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				<li class="active">书籍分类统计</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">书籍分类情况统计</h1>
			</div>
		</div><!--/.row-->
		<div class="row" >
			<div class="col-lg-12">
				<div class="panel panel-default" >
					<div class="panel-heading">分类汇总</div>
					<div class="panel-body">
						<table>
						    <thead>
						    <tr>
						        <th style="width:280px;text-align: center">分类ID</th>
						        <th style="width:280px;text-align: center">分类名</th>
						        <th style="width:280px;text-align: center">分类描述</th>
						    </tr>
						    </thead>
						    <tbody>
