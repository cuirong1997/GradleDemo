...
<body>
	...
	<div id="page">
		...
		<div class="gtco-container">
			...
			<div class="row animate-box">
				<div class="panel panel-default col-lg-12" >
					<div class="panel-heading">购物车商品清单</div>
					<div class="panel-body">
						<table>
						    <thead>
							    <tr>
							        <th style="width:450px;">购买书籍名称</th>
							        <th style="width:450px;">购买数量</th>
							        <th style="width:450px;">单价</th>
		...
		<div class="gtco-container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center">
					<p style="font-weight: bold;text-align:center;margin-right:18%;">用&nbsp;户&nbsp;操&nbsp;作</p>
				</div>
			</div>
			<div class="row animate-box">
				<div class="col-md-12" style="text-align:right;">
					...
					<form class="form-inline" action="cdelete" method="post">
						...
						<div class="col-md-4 col-sm-4">
							<div class="form-group">
								<a href="updatecart"><input type="button" class="btn btn-primary" value="修改购物车"></a>
							</div>
						</div>
					</form>
				</div>
