...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="mindex"><span class="glyphicon glyphicon-pencil"></span>后台系统首页</a></li>
			<li>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="panel panel-teal">
					<div class="panel-heading dark-overlay">书籍管理模块</div>
					<div class="panel-body">
						<p>管理员可以在这个模块内，管理网站售出商品。对网站所售的书籍进行添加、修改、删除等操作。</p>
					</div>
				</div>
			</div><!--/.col-->
			...
			<div class="col-md-6">
				<div class="panel panel-orange">
					...
					<div class="panel-body">
						<p>管理员可以在这个模块内，查看用户对于网站商品下单的订单信息。</p>
						<br/>
					</div>
				</div>
			</div><!--/.col-->
			...
			<div class="col-md-6">
				<div class="panel panel-red">
					...
					<div class="panel-body">
						<p>管理员可以在这个模块内，查看用户对于所售出书籍的评价。还可以对评价做出处理。</p>
					</div>
				</div>
			</div><!--/.col-->
		</div><!--/.row-->
