...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		...
		<ul class="nav menu">
			...
			<li>
				...
				<ul class="children collapse" id="sub-item-4">
					<li class="active">&emsp;&emsp;&emsp;<a href="readsubject"><span class="glyphicon glyphicon-pencil"></span>查看分类</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				<li class="active">书籍评论统计</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">书籍评论情况统计</h1>
			</div>
		</div><!--/.row-->
		<div class="row" >
			<div class="col-lg-12">
				<div class="panel panel-default" >
					...
					<div class="panel-body">
						<table>
						    <thead>
						    <tr>
						        <th style="width:15%;text-align: center">评论ID</th>
						        <th style="width:15%;text-align: center">用户ID</th>
						        <th style="width:15%;text-align: center">商品ID</th>
						        <th style="text-align: center">评论内容</th>
						    </tr>
						    </thead>
						    <tbody>
						    <c:forEach items="${requestScope.comment_list1 }" var="comment">
								<tr style="text-align: center;height: 40px">
									<td>${comment.com_id}</td>
									<td>${comment.user_id }</td>
									<td>${comment.good_id }</td>
									<td>${comment.com_con }</td>
								</tr>
							</c:forEach>
						    </tbody>
						</table>
