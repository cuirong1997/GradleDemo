...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		...
		<ul class="nav menu">
			...
			<li>
				...
				<ul class="children collapse" id="sub-item-4">
					...
					<li class="active">&emsp;&emsp;&emsp;<a href="updatesubject"><span class="glyphicon glyphicon-pencil"></span> 修改分类</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				<li class="active">书籍分类管理模块</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">修改书籍分类</h1>
			</div>
		</div><!--/.row-->
		<div class="row" >
			<div class="col-lg-12">
				<div class="panel panel-default" >
					<div class="panel-heading">修改书籍分类信息</div>
					<div class="panel-body">
						<form action='supdate' method='post'>
							<div class="form-group">
									<label for="id">分类ID</label>
									<input type='text' name='id' placeholder='SubjectId' id="id" class="form-control">
							</div>
							<div class="form-group">
									<label for="name">分类名称</label>
									<input type='text' name='name' placeholder='SubjectName' id="name" class="form-control">
							</div>
							<div class="form-group">
									<label for="detail">分类描述</label>
									<input type="text" id="detail" class="form-control" name="detail" placeholder="SubjectDetail">
							</div>
							<div class="form-group">
								<center><input type='submit' value='修改分类' class="btn btn-primary"></center>
							</div>
						</form>
					</div>
				</div>
