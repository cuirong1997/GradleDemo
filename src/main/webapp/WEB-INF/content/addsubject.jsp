...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		...
		<ul class="nav menu">
			...
			<li>
				...
				<ul class="children collapse" id="sub-item-4">
					...
					<li class="active">&emsp;&emsp;&emsp;<a href="addsubject"><span class="glyphicon glyphicon-pencil"></span>添加分类</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">添加新书籍分类</h1>
			</div>
		</div><!--/.row-->
		<div class="row" >
			<div class="col-lg-12">
				<div class="panel panel-default" >
					...
					<div class="panel-body">
						<form action='sadd' method='post'>
							...
							<div class="form-group">
								<center><input type='submit' value='添加分类' class="btn btn-primary"></center>
							</div>
						</form>
					</div>
				</div>
