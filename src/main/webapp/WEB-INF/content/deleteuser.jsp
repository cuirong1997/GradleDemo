...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				<li class="active">用户管理模块</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">删除注册用户</h1>
			</div>
		</div><!--/.row-->
		<div class="row" >
			<div class="col-lg-12">
				<div class="panel panel-default" >
					<div class="panel-heading">删除用户信息</div>
					<div class="panel-body">
						<form action='udelete' method='post'>
							<div class="form-group">
									<label for="id">用户ID</label>
									<input type='text' name='id' placeholder='UserId' id="id" class="form-control">
							</div>
							<div class="form-group">
								<center><input type='submit' value='删除用户' class="btn btn-primary"></center>
							</div>
						</form>
					</div>
				</div>
